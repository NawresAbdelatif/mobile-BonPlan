...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new CommentDatabaseHelper(this);
    ...
    class CommentAdapter extends ArrayAdapter<Comment> {
        ...
        CommentAdapter(ArrayList<Comment> comments) {
            super(MainActivity.this, 0, comments);
        }
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setPositiveButton("Oui", (dialog, which) -> {
                        ...
                        Toast.makeText(MainActivity.this, "Commentaire supprimé", Toast.LENGTH_SHORT).show();
                    });
            ...
            builder.setPositiveButton("OK", (dialog, which) -> {
                ...
                if (!nouveauCommentaire.isEmpty()) {
                    ...
                    if (containsBadWords(nouveauCommentaire)) {
                        Toast.makeText(MainActivity.this, "Le commentaire contient des mots interdits", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        notifyDataSetChanged();
                        Toast.makeText(MainActivity.this, "Commentaire modifié", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(MainActivity.this, "Le commentaire ne peut pas être vide", Toast.LENGTH_SHORT).show();
                }
            });
